<!-- ESSE CÓDIGO PASSOU A SER UTILIZADO A PARTIR DE 31/10/2025 - 20:09 -->
...
<div class="container mt-5">
    <div class="card shadow-sm border-0 rounded-3">
        ...
        <div class="card-body">
            ...
            <%-- Mensagem de erro do Servlet (ex: duplicado) --%>
            ...
            <form action="${pageContext.request.contextPath}/ExtintorServlet" method="post" class="needs-validation" novalidate>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <%-- CORRIGIDO: Adicionado 'value' para repopular --%>
                        <input type="text" class="form-control" id="numeroControle" name="numeroControle" 
                               value="<c:out value='${extintor.numeroControle}'/>" required>
                        <div class="invalid-feedback">Obrigatório.</div>
                    </div>
                    <div class="col-md-6">
                        <label for="tipoEquipamento" class="form-label">Tipo Equipamento*</label>
                        <%-- CORRIGIDO: Adicionado 'selected' para repopular --%>
                 ...
                 <div class="row mb-3">
                    <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                        ...
                        <%-- CORRIGIDO: Adicionado 'value' para repopular --%>
                        <input type="text" class="form-control" id="cargaNominal" name="cargaNominal" placeholder="Ex: 4Kg, 10L" 
                               value="<c:out value='${extintor.cargaNominal}'/>" required>
                        <div class="invalid-feedback">Obrigatório.</div>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control" id="dataRecarga" name="dataRecarga"
                               value="${not empty dataRecargaValor ? dataRecargaValor : dataRecargaFormatada}">
                    </div>
                    <div class="col-md-6">
                        <label for="dataValidade" class="form-label">Data de Validade*</label>
                        <input type="date" class="form-control" id="dataValidade" name="dataValidade" 
                               value="${not empty dataValidadeValor ? dataValidadeValor : dataValidadeFormatada}" required>
                         <div class="invalid-feedback">Obrigatório.</div>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                     <div class="col-md-12">
                        ...
                        <%-- CORRIGIDO: Adicionado 'value' para repopular --%>
                        <input type="text" class="form-control" id="referenciaLocalizacao" name="referenciaLocalizacao" placeholder="Ex: Corredor A, Pilar 5" 
                               value="<c:out value='${extintor.referenciaLocalizacao}'/>" required>
                         <div class="invalid-feedback">Obrigatório.</div>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                     <div class="col-md-12">
                        ...
                        <%-- CORRIGIDO: Adicionado texto para repopular --%>
...
<!-- ESSE CÓDIGO FOI UTILIZADO ATÉ 31/10/2025 - 20:07
<%@ page contentType="text/html; charset=UTF-8" language="java" %>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
<!DOCTYPE html>
