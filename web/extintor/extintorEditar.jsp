                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control" id="dataRecarga" name="dataRecarga"
                               value="<fmt:formatDate value='${extintor.dataRecarga}' pattern='yyyy-MM-dd'/>" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control" id="dataValidade" name="dataValidade"
                               value="<fmt:formatDate value='${extintor.dataValidade}' pattern='yyyy-MM-dd'/>" required>
