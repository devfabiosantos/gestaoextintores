                ...
                <form action="${pageContext.request.contextPath}/FilialServlet" method="post" class="needs-validation" novalidate>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-text" id="cepFeedback">Você pode usar a busca automática por CEP ou editar os dados manualmente.</div>
        ...
        (function () {
            ...
            async function buscarCep() {
                ...
                try {
                    ...
                    if (data.erro) {
                        atualizarFeedback('CEP não encontrado. Ajuste o endereço manualmente.', 'erro');
                        return;
                    }
